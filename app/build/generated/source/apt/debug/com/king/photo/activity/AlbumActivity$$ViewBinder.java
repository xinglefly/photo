...
public class AlbumActivity$$ViewBinder<T extends AlbumActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296270, "field 'gridViewAlbum'");
    target.gridViewAlbum = finder.castView(view, 2131296270, "field 'gridViewAlbum'");
    view = finder.findRequiredView(source, 2131296271, "field 'tvNone'");
    target.tvNone = finder.castView(view, 2131296271, "field 'tvNone'");
    view = finder.findRequiredView(source, 2131296265, "method 'onButtonClick'");
    unbinder.view2131296265 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onButtonClick(p0);
